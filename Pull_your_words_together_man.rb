...
# So, he wants you to write the last part of his code, a sentencify function, which takes the output that 
# the machine gives, and formats it into proper English orthography.
...
words = ["FIELDS","of","CORN","are","to","be","sown"]
