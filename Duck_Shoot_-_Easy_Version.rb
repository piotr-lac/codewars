...
# shots you will be able to make given the available ammo and your aim score, 
# then return a string representing the pool of ducks, with those ducks shot marked with 'X' 
# and those that survived left unchanged. You will always shoot left to right.
...
puts duck_shoot(5, 0.48,"|~~2~2~~~2~~~~~~22~2~~~~~~~~22~2~~~~~~|")
